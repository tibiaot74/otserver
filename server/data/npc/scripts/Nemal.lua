...
if msgcontains(msg, 'potion') and msgcontains(msg, 'regain') and msgcontains(msg, 'vision') or msgcontains(msg, 'Potion') and msgcontains(msg, 'Regain') and msgcontains(msg, 'Vision') then
	NPCSay("I heard of a potion of regained vision ... but I can't remember how to make it! Maybe you can help me. Do you know something about it?", 1)
	nemal_talk_state = 2
			
elseif nemal_talk_state == 2 and msgcontains(msg, 'yes') or nemal_talk_state == 2 and msgcontains(msg, 'Yes') then
	NPCSay("So, did you bring the ingredients with you, stranger?", 1)
	nemal_talk_state = 3
elseif nemal_talk_state == 2 and msgcontains(msg, '') then
	NPCSay("Oh. Maybe someone else could do it, then.", 1)
	nemal_talk_state = 0
...
elseif nemal_talk_state == 3 and msgcontains(msg, '') then
	NPCSay("Maybe you can find them!", 1)
	nemal_talk_state = 0	

elseif nemal_talk_state == 4 and msgcontains(msg, '31') then
	NPCSay("Ah. It seems to work. But what are the words I have to speak?", 1)
	nemal_talk_state = 5	
elseif nemal_talk_state == 4 and msgcontains(msg, '') then
	NPCSay("Oh no, I don't think this is right.", 1)
	nemal_talk_state = 0
	
elseif nemal_talk_state == 5 and msgcontains(msg, 'nalus murtu') or nemal_talk_state == 5 and msgcontains(msg, 'Nalus Murtu') then
	NPCSay("Thank you! NALUS MURTUUU! ... I can see again! To show you, how grateful I am, I'll give you a key. Be wise when using it. I can't tell you, where it matches, but ... take good care, it is useless without mental powers!", 1)
...
elseif nemal_talk_state == 5 and msgcontains(msg, '') then
	NPCSay("Oh no, I don't think these are the right words.", 1)
	nemal_talk_state = 0	
