...
---------------------------------------SVARGROND CONFIG------------------------------------------- 
local SvargrondPosition = {x=21478, y=21154, z=7}         ----> Destination from Svargrond <---- 
local SvargrondHopeCost = 180                                      ----> Cost to Travel for Svargrond    <---- 
...
---CARLIN----------------------------------------------------------------------------------------------------------------------------------------- 
local CarlinText = 'Do you want to Travel to Carlin for 110 gold coins?' 
...
---Venore----------------------------------------------------------------------------------------------------------------------------------------- 
local VenoreText = 'Do you want to Travel to Venore for 170 gold coins?' 
...
---AbDendriel----------------------------------------------------------------------------------------------------------------------------------------- 
local AbDendrielText = 'Do you want to Travel to Ab\'Dendriel for 130 gold coins?' 
...
---Svargrond----------------------------------------------------------------------------------------------------------------------------------------- 
local SvargrondText = 'Do you want to Travel to Svargrond for 180 gold coins?' 
local SvargrondTextNo = 'Ok, come back when you want then!' 
local NoTravel = 'Sorry, i do not travel to this city..' 
local SvargrondCost = 180 
