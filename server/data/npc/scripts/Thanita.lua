...
if msgcontains(msg, 'beasts') or msgcontains(msg, 'Beasts') or msgcontains(msg, 'orc') or msgcontains(msg, 'them') or msgcontains(msg, 'raid') or msgcontains(msg, 'Orc') then
	NPCSay("These green, orcish raiders come in masses. Hundreds of them. They are worse than those goblins I have to deal with from time to time. ...", 1)
	NPCSay("Some of them come on beastly warwolves, others shoot fireballs at you and some are just plain ugly. ...", 5)
	NPCSay("They have never succeeded though in capturing this tower. So far I have always been able to put them to flight.", 9)
	name_talk_state = 0
			
elseif msgcontains(msg, 'mission') or msgcontains(msg, 'Mission') or msgcontains(msg, 'quest') or msgcontains(msg, 'Quest') then
	NPCSay("Well, I cannot provide you with a mission, I have a mission to fulfill myself. ...", 1)
	NPCSay("However, when the orcs attack, you are more than welcome to help me to defeat them. ...", 5)
	NPCSay("I'll even let you have all the stuff they carry with them. Even if they looted it from the tower here.", 9)
	name_talk_state = 0

elseif msgcontains(msg, 'amazon') or msgcontains(msg, 'Amazon') then
	NPCSay("I see you have heard of amazons before. Well let me tell you, probably everything you heard is true. We are much stronger and tougher than people think. Also, we know how to fight and could teach many men how to handle a weapon. ...", 1)
	NPCSay("Not that we would do such a foolish thing.", 5)
	name_talk_state = 0
