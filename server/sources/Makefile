...
pkgdatadir = $(datadir)/otxserver
pkgincludedir = $(includedir)/otxserver
pkglibdir = $(libdir)/otxserver
pkglibexecdir = $(libexecdir)/otxserver
...
PRE_UNINSTALL = :
POST_UNINSTALL = :
noinst_PROGRAMS = theotxserver$(EXEEXT)
subdir = .
...
am__theotxserver_SOURCES_DIST = account.h actions.cpp actions.h \
	baseevents.cpp baseevents.h beds.cpp beds.h chat.cpp chat.h \
	combat.cpp combat.h condition.cpp condition.h config.h \
	configmanager.cpp configmanager.h connection.cpp connection.h \
	...
	databasemysql.cpp databasemysql.h databasemysqlpp.cpp \
	databasemysqlpp.h databasesqlite.cpp databasesqlite.h \
	databasepgsql.cpp databasepgsql.h depot.cpp depot.h \
	dispatcher.cpp dispatcher.h exception.cpp exception.h \
	fileloader.cpp fileloader.h game.cpp game.h gameservers.cpp \
	gameservers.h globalevent.cpp globalevent.h group.cpp group.h \
	gui.cpp gui.h house.cpp house.h housetile.cpp housetile.h \
	inputbox.cpp inputbox.h ioban.cpp ioban.h ioguild.cpp \
	ioguild.h iologindata.cpp iologindata.h iomap.cpp iomap.h \
	iomapserialize.cpp iomapserialize.h item.cpp item.h \
	itemattributes.cpp itemattributes.h items.cpp items.h \
	luascript.cpp luascript.h mailbox.cpp mailbox.h map.cpp map.h \
	monster.cpp monster.h monsters.cpp monsters.h movement.cpp \
	movement.h networkmessage.cpp networkmessage.h npc.cpp npc.h \
	otpch.cpp otpch.h otserv.cpp otsystem.h outfit.cpp outfit.h \
	outputmessage.cpp outputmessage.h party.cpp party.h \
	playerbox.cpp playerbox.h player.cpp player.h position.cpp \
	position.h protocol.cpp protocol.h protocolgame.cpp \
	protocolgame.h protocollogin.cpp protocollogin.h raids.cpp \
	raids.h resources.h scheduler.cpp scheduler.h \
	scriptmanager.cpp scriptmanager.h server.cpp server.h \
	spawn.cpp spawn.h spectators.cpp spectators.h spells.cpp \
	spells.h status.cpp status.h talkaction.cpp talkaction.h \
	teleport.cpp teleport.h templates.h textlogger.cpp \
	textlogger.h thing.cpp thing.h tile.cpp tile.h tools.cpp \
	tools.h town.h trashholder.cpp trashholder.h waitlist.cpp \
	waitlist.h waypoints.h weapons.cpp weapons.h vocation.cpp \
	vocation.h
am__objects_1 = databasemysql.$(OBJEXT)
#am__objects_2 = databasemysqlpp.$(OBJEXT)
#am__objects_3 = databasesqlite.$(OBJEXT)
#am__objects_4 = databasepgsql.$(OBJEXT)
#am__objects_5 = gameservers.$(OBJEXT)
am_theotxserver_OBJECTS = actions.$(OBJEXT) baseevents.$(OBJEXT) \
	beds.$(OBJEXT) chat.$(OBJEXT) combat.$(OBJEXT) \
	condition.$(OBJEXT) configmanager.$(OBJEXT) \
	connection.$(OBJEXT) container.$(OBJEXT) creature.$(OBJEXT) \
	creatureevent.$(OBJEXT) cylinder.$(OBJEXT) database.$(OBJEXT) \
	databasemanager.$(OBJEXT) $(am__objects_1) $(am__objects_2) \
	$(am__objects_3) $(am__objects_4) depot.$(OBJEXT) \
	dispatcher.$(OBJEXT) exception.$(OBJEXT) fileloader.$(OBJEXT) \
	game.$(OBJEXT) $(am__objects_5) globalevent.$(OBJEXT) \
	group.$(OBJEXT) gui.$(OBJEXT) house.$(OBJEXT) \
	housetile.$(OBJEXT) inputbox.$(OBJEXT) ioban.$(OBJEXT) \
	...
	mailbox.$(OBJEXT) map.$(OBJEXT) monster.$(OBJEXT) \
	monsters.$(OBJEXT) movement.$(OBJEXT) networkmessage.$(OBJEXT) \
	npc.$(OBJEXT) otpch.$(OBJEXT) otserv.$(OBJEXT) \
	outfit.$(OBJEXT) outputmessage.$(OBJEXT) party.$(OBJEXT) \
	playerbox.$(OBJEXT) player.$(OBJEXT) position.$(OBJEXT) \
	protocol.$(OBJEXT) protocolgame.$(OBJEXT) \
	protocollogin.$(OBJEXT) raids.$(OBJEXT) scheduler.$(OBJEXT) \
	scriptmanager.$(OBJEXT) server.$(OBJEXT) spawn.$(OBJEXT) \
	spectators.$(OBJEXT) spells.$(OBJEXT) status.$(OBJEXT) \
	talkaction.$(OBJEXT) teleport.$(OBJEXT) textlogger.$(OBJEXT) \
	thing.$(OBJEXT) tile.$(OBJEXT) tools.$(OBJEXT) \
	trashholder.$(OBJEXT) waitlist.$(OBJEXT) weapons.$(OBJEXT) \
	vocation.$(OBJEXT)
theotxserver_OBJECTS = $(am_theotxserver_OBJECTS)
am__DEPENDENCIES_1 =
theotxserver_DEPENDENCIES = $(am__DEPENDENCIES_1)
DEFAULT_INCLUDES = -I.
...
SOURCES = $(theotxserver_SOURCES)
DIST_SOURCES = $(am__theotxserver_SOURCES_DIST)
...
ACLOCAL = ${SHELL} /otserv/sourcesBOT/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AUTOCONF = ${SHELL} /otserv/sourcesBOT/missing --run autoconf
AUTOHEADER = ${SHELL} /otserv/sourcesBOT/missing --run autoheader
AUTOMAKE = ${SHELL} /otserv/sourcesBOT/missing --run automake-1.11
AWK = gawk
CPPFLAGS = 
CXX = g++
CXXCPP = g++ -E
...
LDFLAGS = 
LIBOBJS = 
LIBS = -lmysqlclient -llua5.1 -lboost_filesystem-mt -lboost_date_time-mt -lboost_system-mt -lboost_regex-mt -lboost_thread-mt -lcrypto -lpthread -lz  -L/usr/lib -lxml2
LTLIBOBJS = 
LUA_CFLAGS = 
LUA_LIBS = 
MAKEINFO = ${SHELL} /otserv/sourcesBOT/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
MYSQLPP_FLAGS = 
MYSQLPP_LIBS = 
...
OBJEXT = o
OPTIONAL_FLAGS =  -D__ROOT_PERMISSION__ -D__ALT_LUA_PATH__
PACKAGE = otxserver
PACKAGE_BUGREPORT = 
PACKAGE_NAME = OTXServer
PACKAGE_STRING = OTXServer 2.X.Series
PACKAGE_TARNAME = otxserver
PACKAGE_URL = 
PACKAGE_VERSION = 2.X.Series
PATH_SEPARATOR = :
PGSQL_FLAGS = 
PGSQL_LIBS = 
PKG_CONFIG = 
...
abs_builddir = /otserv/sourcesBOT
abs_srcdir = /otserv/sourcesBOT
abs_top_builddir = /otserv/sourcesBOT
abs_top_srcdir = /otserv/sourcesBOT
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /otserv/sourcesBOT/install-sh
...
$(OPTIONAL_FLAGS) -D_MULTIPLATFORM77 -D_THREAD_SAFE -D_REENTRANT -Wall -Wextra -Wno-strict-aliasing -Wno-unused-parameter -Wno-array-bounds -pthread -D_MULTIPLATFORM77
...
theotxserver_SOURCES = account.h actions.cpp actions.h  baseevents.cpp baseevents.h beds.cpp \
	...
	mailbox.cpp mailbox.h map.cpp map.h monster.cpp \
...
theotxserver$(EXEEXT): $(theotxserver_OBJECTS) $(theotxserver_DEPENDENCIES) $(EXTRA_theotxserver_DEPENDENCIES) 
	@rm -f theotxserver$(EXEEXT)
	$(AM_V_CXXLD)$(CXXLINK) $(theotxserver_OBJECTS) $(theotxserver_LDADD) $(LIBS)
...
include ./$(DEPDIR)/databasemysqlpp.Po
