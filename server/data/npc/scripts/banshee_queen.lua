...
function creatureSayCallback(cid, type, msg)
	...
	local primeiro_selo = getPlayerStorageValue(cid, 9800)
	local segundo_selo = getPlayerStorageValue(cid, 9900)
	local terceiro_selo = getPlayerStorageValue(cid, 9100)
	local quarto_selo = getPlayerStorageValue(cid, 9120)
	local quinto_selo = getPlayerStorageValue(cid, 9180)
	local sexto_selo = getPlayerStorageValue(cid, 9170)
